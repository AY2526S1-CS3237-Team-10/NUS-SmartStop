...
│                                                                  │
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐       │
│  │ ESP32    │  │Ultrasonic│  │ Speaker  │  │  Other   │       │
│  │ Camera   │  │ Sensor   │  │          │  │ Sensors  │       │
│  └────┬─────┘  └────┬─────┘  └────┬─────┘  └────┬─────┘       │
│       │             │              │             │              │
│       │             └──────────────┴─────────────┘              │
│       │                         │                                │
...
│                                                                  │
│  ┌──────────────┐                                               │
│  │ Flask Server │ ◄─────── HTTP (Images) from ESP32-CAM        │
│  │  (Port 5000) │                                               │
│  │              │                                               │
│  │  - Receives  │                                               │
│  │    Images    │                                               │
...
│  │                    MQTT Broker                             │ │
│  │                   (Mosquitto)                              │ │
│  │  Topics: nus-smartstop/sensors/*, command/*               │ │
│  └─────┬────────────────────────────────────────────┬─────────┘ │
│        │                                             │           │
│        │ ◄────── Sensor Data from ESP32 Devices     │           │
│        │                                                         │
│  ┌─────▼─────────┐                                              │
│  │   Telegraf    │                                              │
│  │  MQTT → DB    │                                              │
...
#### Web Gallery
Open `http://localhost:5000/` in your browser to view uploaded images.
...
- **InfluxDB**: Runs locally (127.0.0.1:8086), token-based authentication
